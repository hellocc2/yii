...
$_['text_minimum_total'] = '最小订单总额：';
$_['text_all_geo_zones'] = 'All Geo Zones';
$_['text_status_enabled'] = '启用';
$_['text_status_disabled'] = '停用';
$_['text_default_order_status'] = 'Pending:';
$_['text_ready_order_status'] = '准备发货的状态：';
$_['text_canceled_order_status'] = '取消订单的状态：';
$_['text_shipped_order_status'] = '发货订单状态：';
$_['text_last_cron_job_run'] = "Last cron job's run time:";
$_['text_allowed_ips'] = "IPs allowed";
$_['text_add'] = "Add";

$_['text_upload_success'] = '文件上传成功';
...
// Errors
$_['error_permissions'] = '您没有权限修改此模块';
$_['error_empty_access_secret'] = '密钥必填';
$_['error_empty_access_key'] = '访问密钥必填';
$_['error_empty_merchant_id'] = '商家ID必填';
$_['error_curreny'] = '你的店必须要安装并启用％的货币，';

$_['error_upload'] = '上传失败';

// Checkout button settings
$_['text_button_settings'] = 'Checkout按钮设置';
$_['text_colour'] = '颜色:';
$_['text_orange'] = '橙色';
$_['text_tan'] = '棕褐色';
$_['text_white'] = '白色';
