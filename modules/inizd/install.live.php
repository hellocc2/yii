...
function install_links()
{
	...
	if (!$zzxgj)
	{
		$zzxgj_link_list = array(
			array (
				'name' => _getaarrayrandval(array('微商城系统','微营销系统','收入倍增平台','微信o2o系统','微网店系统','微信业务平台','互联网+平台',)),
				'url' => 'http:/'.'/www.haoyebao.com',
			),
			array (
				'name' => _getaarrayrandval(array('微商城系统','微信团购系统','微营销系统','微信o2o系统','微网店系统',)),
				'url' => 'http:/'.'/biniu.com',
			),
			array (
				'name' => _getaarrayrandval(array('天天团购系统','微商城系统','php团购系统','团购网站系统','开源团购程序','b2b2c源码系统','团购网站模板','团购网站源码','o2o源码下载','o2o系统',)),
							'url' => 'http:/'.'/www.tttuangou.com',
			),
