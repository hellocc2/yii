...
团购券编号：{number}
密码：{password}',
        'sms' => '感谢您购买“{product.flag}”！您的团购券编号：{number}，密码：{password}，过期时间：{product.perioddate}，请尽快使用，以免过期！联系电话：{product.sellerphone}',
      ),
      'cfg' => 
      array (
        'mail' => 
...
{reply}',
    ...
    'remind_seller_delivery' => array(
        'struct' => 'orderid,productflag,paymoney,',
        'name' => '提醒商家发货',
        'intro' => '当用户购买实物商品，在支付完成时会触发此通知',
        'hook' => 
        array (
          'sms' => 
          array (
        ...
        'msg' => 
        array (
          'sms' => '产品：{productflag} 订单：{orderid} 。用户已成功付款，收货人：{address_name}，联系电话：{address_phone}，收货地址：{address}，请尽快安排发货',
          'mail' => '产品：{productflag} 订单：{orderid} 。用户已成功付款，收货人：{address_name}，联系电话：{address_phone}，收货地址：{address}，请尽快安排发货',
        ),
        'cfg' => 
        array (          
          'sms' => 
    ...
    'user_buy_rebate' => array(
        'struct' => 'username,paymoney,rebate_money,',
        'name' => '提醒用户获得邀请返利',
        'intro' => '当被邀请人购买了商品后，网站给邀请人返利时触发此通知',
        'hook' => 
        array (
          'sms' => 
          array (
        ...
        'msg' => 
        array (
          'sms' => '您成功获得用户：{username} 在网站的消费返利，可登录网站了解详情',
          'mail' => '用户：{username} 成功消费了{paymoney}元，你获得网站返利：{rebate_money}元，可登录网站了解详情',
        ),
        'cfg' => 
        array (          
          'sms' => 
    ...
    'logic_creditmall_order_create' => array(
        'struct' => 'username,time,',
        'name' => '积分商城用户下单时触发此通知',
        'intro' => '用户通过积分兑换产品后触发此通知',
        'hook' => 
        array (
          'sms' => 
          array (
        ...
        'msg' => 
        array (
          'sms' => '用户：{username} 已于{time}通过积分兑换商品，请尽快处理',
          'mail' => '用户：{username} 已于{time}通过积分兑换商品，请尽快处理',
        ),
        'cfg' => 
        array (          
          'sms' => 
    ...
    'logic_creditmall_order_status' => array(
        'struct' => 'username,orderid,time,status,',
        'name' => '后台变更积分订单状态时触发此通知',
        'intro' => '管理员后台处理积分商城产品兑换订单的状态时触发此通知',
        'hook' => 
        array (
          'sms' => 
          array (
        ...
        'msg' => 
        array (
          'sms' => '用户：{username} 订单号：{orderid} 网站已于{time}更新状态为{status}，可登录客户端了解详情',
          'mail' => '用户：{username} 订单号：{orderid} 网站已于{time}更新状态为{status}，可登录客户端了解详情',
        ),
        'cfg' => 
        array (          
          'sms' => 
    ...
    'logic_cash_orderdone' => array(
        'struct' => 'username,orderid,money,status,',
        'name' => '提现处理结果触发此通知',
        'intro' => '当管理员处理完一条提现信息后，系统触发此通知',
        'hook' => 
        array (
          'sms' => 
          array (
        ...
        'msg' => 
        array (
          'sms' => '用户：{username} 提现流水号：{orderid} 提现金额：{money}元。网站已变更状态为{status}，可登录网站了解详情',
          'mail' => '用户：{username} 提现流水号：{orderid} 提现金额：{money}元。网站已变更状态为{status}，可登录网站了解详情',
        ),
        'cfg' => 
        array (          
          'sms' => 
    ...
    'logic_fund_orderdone' => array(
        'struct' => 'username,orderid,money,status,',
        'name' => '商家结算处理结果触发此通知',
        'intro' => '当管理员处理完一条商家结算信息的时候，系统触发此通知',
        'hook' => 
        array (
          'sms' => 
          array (
        ...
        'msg' => 
        array (
          'sms' => '用户：{username} 结算流水号：{orderid} 结算金额：{money}元。网站已变更状态为{status}，可登录网站了解详情',
          'mail' => '用户：{username} 结算流水号：{orderid} 结算金额：{money}元。网站已变更状态为{status}，可登录网站了解详情',
        ),
        'cfg' => 
        array (          
          'sms' => 
